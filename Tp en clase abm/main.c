...
int main()
{
    ...
    producto_arrayProductos[CANTIDAD_PRODUCTOS];
    producto_init(arrayProductos,CANTIDAD_PRODUCTOS,1);

    producto_altaProducto(arrayProductos,CANTIDAD_PRODUCTOS,0);
    printf("\n---%s",arrayProductos[0].nombre);

    producto_mostrar(arrayProductos,CANTIDAD_PRODUCTOS);

    producto_lugarLibre(arrayProductos,CANTIDAD_PRODUCTOS,&libre);

    printf("El lugar libre es %d",libre);
